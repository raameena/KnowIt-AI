...
def handle_casual_query(user_prompt, FLASH_MODEL):
    ...
    Respond with a short, friendly, and encouraging message that gently guides them back to asking a homework-related question. Keep your response to one or two sentences.
